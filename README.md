![docker image](https://github.com/nomad-hzb/hzb-ce-image/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/nomad-hzb/hzb-ce-image.git
    cd hzb-ce-image
    ```
    ...
    ```sh
    curl-L -o hzb-ce-image.zip "https://github.com/nomad-hzb/hzb-ce-image/archive/main.zip"
    unzip hzb-ce-image.zip
    cd hzb-ce-image
    ```
...
your `docker-compose.yaml` with `ghcr.io/nomad-hzb/hzb-ce-image:main` for the services
...
```sh
docker pull ghcr.io/nomad-hzb/hzb-ce-image/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/nomad-hzb/hzb-ce-image/manifests/main": unauthorized`
